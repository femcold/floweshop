...
const NewAccountModal = ({ showModal, handleClose, onSave, onAccountCreated, salesOrderNumber }) => {
  ...
  useEffect(() => {
    const fetchAutogeneratedNumber = async () => {
      try {
        ...
        console.log('UI Generated Account Number:', customerAccountNumber);
    ...
    if (showModal && !isAccountCreated) {
      fetchAutogeneratedNumber();
    }
  }, [showModal, isAccountCreated]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const formData = {
        ...newAccountData,
        customerAccount: newAccountData.customerAccount || salesOrderNumber,
      };
